...
export class UserDto {
  @ApiProperty({ example: '07a59e63-1f9c-4f7e-a78a-9f8aea3a0c75', description: 'Unique identifier of the user (UUID)' })
  id: string;
  ...
  @ApiProperty({ enum: UserRole, isArray: true, example: [UserRole.USER], description: 'Roles assigned to the user' })
  roles: UserRole[];
