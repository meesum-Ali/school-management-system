...
import { LoginDto } from './dto/login.dto'; // For typing in a potential login method here or in controller

// Omit password from user object returned by validateUser or login
export type ValidatedUser = Omit<User, 'password' | 'comparePassword' | 'hashPassword'>;
