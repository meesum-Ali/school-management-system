...
export class ClassesController {
  ...
  @ApiResponse({
    ...
    description: 'Conflict - Class name already exists in this school.',
  })
  async create(
  ...
  @Get()
  @ApiOperation({
    summary: "Get all classes for the admin's school (Admin only)",
  })
  @ApiResponse({
  ...
  @Get(':id')
  @ApiOperation({
    summary: "Get a class by ID from the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiResponse({
    ...
    description: 'Not Found - Class not found in this school.',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
  ...
  @Patch(':id')
  @ApiOperation({
    summary: "Update a class by ID in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiResponse({
    status: HttpStatus.CONFLICT,
    description: 'Conflict - Class name already exists on another class.',
  })
  async update(
    @Param('id', ParseUUIDPipe) id: string,
  ...
  @Delete(':id')
  @ApiOperation({
    summary: "Delete a class by ID in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'id',
    type: 'string',
  ...
  @ApiOperation({
    summary: "Assign a subject to a class in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'classId',
    type: 'string',
  ...
  @ApiOperation({
    summary: "Remove a subject from a class in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'classId',
    type: 'string',
  ...
  @ApiParam({
    ...
    type: 'string',
    format: 'uuid',
    description: 'ID of the subject to remove',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description:
      'Class not found, or Subject not found in class in this school.',
  })
  @ApiResponse({
    status: HttpStatus.UNAUTHORIZED,
    description: 'Unauthorized.',
  ...
  async removeSubjectFromClass(
    ...
    const schoolId = this.getSchoolIdFromRequest(req);
    return this.classesService.removeSubjectFromClass(
      classId,
      subjectId,
      schoolId,
    );
  ...
  @ApiOperation({
    summary: "List all subjects for a class in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'classId',
    type: 'string',
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Subjects for the class retrieved successfully.',
    type: [SubjectDto],
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Class not found in this school.',
  })
  @ApiResponse({
    status: HttpStatus.UNAUTHORIZED,
    description: 'Unauthorized.',
  ...
  @ApiOperation({
    summary:
      "List all students enrolled in a specific class in the admin's school (Admin only)",
  })
  @ApiParam({
    name: 'classId',
    type: 'string',
