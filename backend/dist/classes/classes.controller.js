...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.NOT_FOUND,
        description: 'Class not found, or Subject not found in class in this school.',
    }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.UNAUTHORIZED,
        description: 'Unauthorized.',
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        summary: "List all students enrolled in a specific class in the admin's school (Admin only)",
    }),
    (0, swagger_1.ApiParam)({
        name: 'classId',
        type: 'string',
