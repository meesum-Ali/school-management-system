...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        type: () => [subject_basic_dto_1.SubjectBasicDto],
        description: 'List of subjects associated with this class',
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        description: 'List of students enrolled in this class (if requested)',
    }),
    __metadata("design:type", Array)
