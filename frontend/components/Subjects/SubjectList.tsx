  ...
  return (
    <Card>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/admin/subjects/create" passHref>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {subjects.map((subject) => (
                <tr key={subject.id}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.id.substring(0,8)}...</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{subject.name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.code || 'N/A'}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                    <Link href={`/admin/subjects/${subject.id}`} passHref>
                      <Button variant="outline" size="sm" className="mr-2">Edit / View Classes</Button>
                    </Link>
                    <Button
                      variant="destructive"
                      size="sm"
