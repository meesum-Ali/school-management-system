...
describe('UserList', () => {
  ...
  it('Edit button has correct link', () => {
    ...
    expect(editLinks[0].closest('a')).toHaveAttribute('href', `/admin/users/${mockUsers[0].id}`);
    expect(editLinks[1].closest('a')).toHaveAttribute('href', `/admin/users/${mockUsers[1].id}`);
  });
});
