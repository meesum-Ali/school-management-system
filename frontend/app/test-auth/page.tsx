    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      {error && (
        <div className="mb-6 p-4 bg-red-100 border border-red-400 rounded">
          ...
          <p className="mt-2 text-sm">This usually means you need to login first.</p>
          <a href="/" className="text-blue-600 underline">Go to Home to Login</a>
        </div>
      )}
        ...
        <>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-6">
              <li><strong>Subject:</strong> {tokenInfo.sub}</li>
              <li><strong>Email:</strong> {tokenInfo.email || 'N/A'}</li>
              <li><strong>Username:</strong> {tokenInfo.preferred_username || tokenInfo.username || 'N/A'}</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="p-4 bg-gray-100 rounded">
              <pre className="text-sm overflow-auto">
                {JSON.stringify(tokenInfo['urn:zitadel:iam:org:project:roles'] || 'No roles found', null, 2)}
              </pre>
            </div>
            {!tokenInfo['urn:zitadel:iam:org:project:roles'] && (
              <p className="mt-2 text-red-600 font-semibold">
                ⚠️ No roles assigned! You need SUPER_ADMIN or SCHOOL_ADMIN role to access /admin routes.
              </p>
            )}
          </div>
          ...
          <div className="mt-6">
            <a href="/admin/dashboard" className="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 mr-4">
              Try Admin Dashboard
            </a>
