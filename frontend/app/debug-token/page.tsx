  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <pre className="bg-gray-100 p-4 rounded overflow-auto text-sm">
          {JSON.stringify(decoded['urn:zitadel:iam:org:project:roles'] || 'No roles claim found', null, 2)}
        </pre>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc pl-6">
          {Object.keys(decoded).map(key => (
            <li key={key}><strong>{key}:</strong> {typeof decoded[key] === 'object' ? JSON.stringify(decoded[key]) : String(decoded[key])}</li>
          ))}
        </ul>
      </div>
