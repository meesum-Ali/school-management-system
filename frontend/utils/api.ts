...
export const updateClass = async (id: string, classData: UpdateClassDto): Promise<Class> => {
  const response = await api.patch<Class>(`${CLASSES_API_PATH}/${id}`, classData);
  return response.data;
};
...
export const assignSubjectToClass = async (classId: string, subjectId: string): Promise<Class> => {
  const response = await api.post<Class>(`${CLASSES_API_PATH}/${classId}/subjects/${subjectId}`);
  return response.data;
};

export const removeSubjectFromClass = async (classId: string, subjectId: string): Promise<Class> => {
  const response = await api.delete<Class>(`${CLASSES_API_PATH}/${classId}/subjects/${subjectId}`);
  return response.data;
};
...
export const updateSubject = async (id: string, subjectData: UpdateSubjectDto): Promise<Subject> => {
  const response = await api.patch<Subject>(`${SUBJECTS_API_PATH}/${id}`, subjectData);
  return response.data;
};
...
export const listClassesForSubject = async (subjectId: string): Promise<ClassType[]> => {
